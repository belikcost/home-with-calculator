...
export const STARTER = 'SUBSCRIPTION-TAGLME-LINK-STARTER';
export const BASIC = 'SUBSCRIPTION-TAGLME-LINK-BASIC';
export const PROFESSIONAL = 'SUBSCRIPTION-TAGLME-LINK-PROFESSIONAL';
export const ENTERPRISE = 'SUBSCRIPTION-TAGLME-LINK-ENTERPRISE';
